...
SRC_URI="
        x86? ( http://bluegriffon.org/freshmeat/2.3.1/bluegriffon-2.3.1.Ubuntu16.04-i686.tar.bz2 )
        amd64? ( http://bluegriffon.org/freshmeat/2.3.1/bluegriffon-2.3.1.Ubuntu16.04-x86_64.tar.bz2 )
        "
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="amd64 ~x86"
