...
#    rm ${S}/${PN}/lib/libct.so
    rm ${S}/${PN}/lib/libhbci4java-card-freebsd-64.so
#    rm ${S}/${PN}/lib/libhbci4java-card-linux-32.so
#    rm ${S}/${PN}/lib/libhbci4java-card-linux-64.so
    rm ${S}/${PN}/lib/libhbci4java-sizrdh-linux-gcc2.so
#    rm ${S}/${PN}/lib/libhbci4java-sizrdh-linux-gcc3.so
#    rm ${S}/${PN}/lib/libtowitoko-2.0.7-amd64.so
#    rm ${S}/${PN}/lib/libtowitoko-2.0.7.so
}
